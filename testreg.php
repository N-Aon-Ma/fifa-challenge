...
if ($myrow['col'] > 2) {
exit ("Вы ввели e-mail или пароль неверно 3 раза. Подождите 15 минут до следующей попытки."); //останавливаем выполнение сценариев
...
$result = mysql_query("SELECT * FROM users WHERE email='$email' AND password='$password' AND activation='1'",$db); //извлекаем из базы все данные о пользователе с введенным логином
